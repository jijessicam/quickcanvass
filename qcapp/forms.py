...
class CampaignForm(forms.Form):
   ...
   targeted_years = forms.ChoiceField(label = 'Set Targeted Class Year', choices=[("any", "All Years"), ("2020", "2020"), ("2019", "2019"), ("2018", "2018"), ("2017", "2017")], widget=forms.Select(attrs={'class':'form-control clean-look selector'}))
...
#Submit a voter's answers to a survey
